...
CREATE PROCEDURE `get_gross_monthly_sales_for_customer_code`(
...
SELECT 
	...
	p.product, p.variant, s.customer_code
	c.market, s.sold_quantity,
...
-- Task 13: Retrieve the top 3 products in every division by their gross sales amount in FY=2021
WITH cte1 AS(SELECT 
p.division,
p.product,
